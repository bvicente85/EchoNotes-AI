...
export const translations: Record<'portuguese' | 'english' | string, TranslationKeys> = {
  portuguese: {
    ...
    signInToAccess: "Inicie sessão para aceder às suas reuniões e inteligência operacional.",
    startCapturing: "Comece a transformar as suas reuniões em conhecimento acionável.",
    ...
    precisionAudio: "Inteligência Executiva & Síntese de Reuniões",
    creatingAccountSuccess: "Conta criada com sucesso! A iniciar sessão...",
    loginError: "Credenciais incorretas ou erro de autenticação.",
    googleError: "Erro ao autenticar com Google.",

    // sidebar & navigation
    navigation: "Navegação",
    dashboard: "Espaço de Reuniões",
    recentSessions: "Reuniões Recentes",
    pinnedSessions: "Reuniões Fixadas",
    manageAccount: "Gerir Conta",
    settings: "Definições",

    // history
    allSessions: "Todas as Reuniões",
    searchPlaceholder: "Pesquisar por título, decisões ou conteúdo...",
    sortBy: "Ordenar por",
    date: "Data",
    title: "Título",
    mostRecent: "Mais Recentes",
    leastRecent: "Mais Antigas",
    noSessionsYet: "Ainda não tem reuniões gravadas.",
    startRecordingToBegin: "Inicie uma gravação ou importe um áudio para começar.",
    noSessionsMatch: "Nenhuma reunião corresponde à pesquisa.",
    rename: "Renomear",
    delete: "Eliminar",
    save: "Guardar",
    cancel: "Cancelar",
    confirmDeleteAllTitle: "Eliminar Todo o Histórico de Reuniões",
    confirmDeleteTitle: "Eliminar Reunião",
    confirmDeleteAllDesc: "Tem a certeza que deseja eliminar todas as reuniões gravadas? Esta ação é irreversível.",
    confirmDeleteDesc: "Tem a certeza que deseja eliminar esta reunião e a respetiva inteligência?",

    // settings view
    profile: "Perfil Executivo",
    yourName: "Nome de Exibição",
    recording: "Preferências de Captura",
    defaultRecordingMode: "Modo de Gravação Padrão",
    inPerson: "Presencial (Microfone)",
    virtualMeeting: "Reunião Virtual (Áudio do Sistema)",
    appearance: "Aparência",
    theme: "Tema",
    light: "Claro",
    dark: "Escuro",
    aiPreferences: "Preferências de Síntese e IA",
    outputLanguage: "Idioma do Relatório",
    summaryDetailLevel: "Nível de Detalhe da Síntese",
    concise: "Conciso & Direto",
    detailed: "Detalhado & Abrangente",
    about: "Sobre a Plataforma",
    signOut: "Terminar Sessão",
    saveChanges: "Guardar Alterações",
    saved: "Guardado",
    manageStorage: "Armazenamento Local",
    manageStorageDesc: "Faça a gestão dos ficheiros áudio guardados localmente no seu dispositivo.",
    storageUsed: "Espaço Ocupado",
    clearStorage: "Limpar Áudios Locais",
    clearStorageDone: "Áudios locais limpos com sucesso",

    // main dash
    recordMeetingsTitle: "Nova Reunião",
    extractIntelligence: "Meeting Intelligence Workspace",
    dashboardDesc: "Grave intervenções em tempo real ou carregue gravações para extrair sínteses executivas, decisões e planos de ação.",
    uploadFile: "Importar Gravação",
    startSession: "Gravar Reunião",
    stopSession: "Concluir Reunião",
    liveRecording: "Reunião em Curso",
    virtualMeetingSetup: "Configuração de Reunião Virtual",
    screenSetupStep1: "1. Clique em 'Iniciar Reunião Virtual' abaixo.",
    screenSetupStep2: "2. Selecione o separador ou janela onde decorre a reunião (Teams, Zoom, Meet).",
    screenSetupStep3: "3. Marque obrigatoriamente a opção 'Partilhar áudio do separador/sistema'.",
    screenSetupStep4: "4. Regresse a este separador enquanto o EchoNotes regista a inteligência em tempo real.",
    screenSetupStep5: "5. Quando terminar, clique em 'Concluir Reunião' para gerar o relatório executivo.",
    synthesizingIntelligence: "A Gerar Inteligência da Reunião...",
    processingDesc: "A Inteligência EchoNotes está a analisar as intervenções, estruturar decisões e extrair o plano de ação.",
    processingTime: "Isto demora normalmente entre 10 e 30 segundos dependendo da duração do áudio.",
    activeIntelligenceReport: "Relatório de Inteligência Ativo",
    micUnavailable: "Microfone indisponível ou permissão recusada.",
    systemAudioFallback: "O áudio do sistema não foi detetado. Por favor, certifique-se de que selecionou a partilha de áudio.",
    fileAnalysisError: "Erro ao processar ficheiro áudio. Por favor, tente novamente.",

    // report view
    executiveSummary: "Síntese Executiva",
    keyHighlights: "Pontos-Chave & Tópicos",
    keyDecisions: "Decisões",
    nextActions: "Plano de Ação",
    fullTranscript: "Transcrição Inteligente & Diarização",
    meetingIntelligenceReport: "Relatório Executivo de Inteligência",
    clientNameLabel: "Entidade / Cliente",
    clientNamePlaceholder: "Ex: SUMA, Direção Executiva, Equipa de Engenharia",
    meetingDateLabel: "Data da Reunião",
    copyReport: "Copiar Síntese",
    copied: "Copiado para a Área de Transferência",
    downloadPdf: "Exportar PDF Executivo",
    downloadJson: "Exportar JSON Estruturado",
    goBack: "Voltar ao Início",
    addNewItem: "Adicionar Item",
    speaker: "Orador",
    timestamp: "Tempo",
    editTranscriptWord: "Editar Transcrição",
    editSummaryWord: "Editar Síntese",
    optimizeVolume: "Otimizar Áudio de Baixo Volume",
    unnamedMeeting: "Reunião Sem Título",
