...
export default function App() {
  ...
  const handleProcessPending = async (pendingId: string) => {
    ...
    if (!pendingItem) {
      setError(t('pendingNotFoundError'));
      return;
    }
                  ...
                  {pendingRecordings.length > 0 && (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className={cn("text-xs font-bold", oldPendingCount > 0 ? "text-red-800 dark:text-red-450" : "text-amber-800 dark:text-amber-450")}>
                            {language === 'portuguese' 
